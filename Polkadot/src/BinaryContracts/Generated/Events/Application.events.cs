    ...
    public partial class Application : IApplication, IWebSocketMessageObserver
    {
        ...
        {  
            settings
                ...
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.NewTip>("Treasury", "NewTip")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.TipClosing>("Treasury", "TipClosing")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.TipClosed>("Treasury", "TipClosed")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.TipRetracted>("Treasury", "TipRetracted")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.BountyProposed>("Treasury", "BountyProposed")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.BountyRejected>("Treasury", "BountyRejected")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.BountyBecameActive>("Treasury", "BountyBecameActive")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.BountyAwarded>("Treasury", "BountyAwarded")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.BountyClaimed>("Treasury", "BountyClaimed")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.BountyCanceled>("Treasury", "BountyCanceled")
                .AddEvent<Polkadot.BinaryContracts.Events.Treasury.BountyExtended>("Treasury", "BountyExtended")
