    ...
    public partial class Application : IApplication, IWebSocketMessageObserver
    {
        ...
        {  
            settings
                ...
                .AddCall<Polkadot.BinaryContracts.Calls.System.SuicideCall>("System", "suicide")
                ...
                .AddCall<Polkadot.BinaryContracts.Calls.Nft.SafeTransferFromCall>("Nft", "safe_transfer_from")
                ...
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.ReportAwesomeCall>("Treasury", "report_awesome")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.RetractTipCall>("Treasury", "retract_tip")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.TipNewCall>("Treasury", "tip_new")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.TipCall>("Treasury", "tip")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.CloseTipCall>("Treasury", "close_tip")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.ProposeBountyCall>("Treasury", "propose_bounty")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.ApproveBountyCall>("Treasury", "approve_bounty")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.ProposeCuratorCall>("Treasury", "propose_curator")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.UnassignCuratorCall>("Treasury", "unassign_curator")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.AcceptCuratorCall>("Treasury", "accept_curator")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.AwardBountyCall>("Treasury", "award_bounty")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.ClaimBountyCall>("Treasury", "claim_bounty")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.CloseBountyCall>("Treasury", "close_bounty")
                .AddCall<Polkadot.BinaryContracts.Calls.Treasury.ExtendBountyExpiryCall>("Treasury", "extend_bounty_expiry")
