namespace PolkaTest
{
    ...
    public class RemoveExtrinsic
    {
        private readonly ITestOutputHelper output;

        public RemoveExtrinsic(ITestOutputHelper output)
        {
            this.output = output;
        }
        ...
        public void Ok()
        {
            using (IApplication app = PolkaApi.GetAppication())
            {
                ...
                output.WriteLine($"Sent extrinsic with hash: {exHash} ");
                output.WriteLine("Now let's try to cancel it... ");
                ...
                {
                    output.WriteLine("Yeah, looks like canceling is not yet supported");
                }
